...
class CaseManager(object):
    ...
    @classmethod
    def create_case_test_scene(cls, case_scene_context, strip, size, io_pattern_name) -> str:
        """
        author: DuPanPan
        date  : 2021.01.18
        ...
        """
        case_test_scene = case_scene_context.format(strip=strip, size=size, io_pattern_name=io_pattern_name)
        case_test_scene = case_test_scene.replace(" ", "").replace("\t", "").strip()
        return case_test_scene

    @classmethod
    def create_case_test_steps(cls, case_steps, strip, size, io_pattern_parm,
                               xfersize, io_pattern_io_check, MixSceneRaid5x.passthrough) -> str:
        """
        author: DuPanPan
        date  : 2021.01.18
        ...
        case_test_steps = case_steps.format(strip=strip, size=size, io_pattern=io_pattern_parm,
    ...
    def create_one_case(cls, case_classification_index, check_point_index, scene_index,
                        ...
                        case_pre_condition, case_scene_context, case_except, MixSceneRaid5x.passthrough) -> \
            dict:
        """
        author: DuPanPan
        date  : 2021.01.18
        ...
        case_dict[constants.case_scene] = cls.create_case_test_scene(case_scene_context, strip, size, io_pattern_name)
        case_dict[constants.case_steps] = cls.create_case_test_steps(case_steps, strip, size, io_pattern_parm,
                                                                     xfersize, io_pattern_io_check,
                                                                     MixSceneRaid5x.passthrough=MixSceneRaid5x.passthrough)
    ...
    def create_case_list(cls) -> None:
        ...
        MixSceneRaid5x.passthrough_list = ["on", "off"]
        ...
        for case in ConfigManager.case_dict_list:
            ...
            for case_check_point_dict in case_check_point_list:
                ...
                for io_pattern in io_pattern_list:
                    ...
                    case_scene_script = "sas_direct_512B_mix"
                    case_scene_title = "直连-512B-混合介质接口物理盘"
                    ...
                    one_case_dict = cls.create_one_case(case_classification_index, case_check_point_index,
                                                        ...
                                                        case_scene_context, case_except, passthough)
