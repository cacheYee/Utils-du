...
class CaseManager(object):
    ...
    def create_case_test_steps(cls,case_steps,  pd_info, strip, size, io_pattern_parm,
                               xfersize, io_pattern_io_check, passthrough, wcache, direct) -> str:
        """
        author: DuPanPan
        date  : 2021.01.18
        ...
        case_test_steps = case_steps.format(pd_info=pd_info, strip=strip, size=size, io_pattern=io_pattern_parm,
                                            io_pattern_io_check=io_pattern_io_check,passthrough=passthrough,
                                            wcache=wcache, direct=direct)
    ...
    def create_one_case(cls, case_classification_index, check_point_index, scene_index,
                        ...
                        case_pre_condition, case_scene_context, case_except, passthrough, wcache, direct, pd_info) -> \
            dict:
        """
        author: DuPanPan
        date  : 2021.01.18
        ...
        case_dict[constants.case_steps] = cls.create_case_test_steps(case_steps, pd_info, strip, size, io_pattern_parm,
                                                                     xfersize, io_pattern_io_check, passthrough, wcache,
                                                                     direct)
    ...
    def create_case_list(cls) -> None:
        ...
        pd_info_list_4kn_ssd = ["直连背板-硬盘粒度为4KN-SATA-SSD(1块)+Expander-硬盘粒度为4KN-SAS-SSD(1块)+"
                                "PCIE·Switch-硬盘粒度为4KN-NVME-SSD(1块)",
                                "直连背板-硬盘粒度为4KN-SATA-SSD(1块)+直连背板-硬盘粒度为4KN-SAS-SSD(1块)+"
                                "直连背板-硬盘粒度为4KN-NVME-SSD(1块)",
                                "Expander-硬盘粒度为4KN-SATA-SSD(1块)+Expander-硬盘粒度为4KN-SAS-SSD(1块)+"
                                "PCIE·Switch-硬盘粒度为4KN-NVME-SSD(1块)"]

        pd_info_list_512B_ssd = ["直连背板-硬盘粒度为512B-SATA-SSD(1块)+直连背板-硬盘粒度为512B-SAS-SSD(1块)+"
                                 "PCIE·Switch-硬盘粒度为512B-NVME-SSD(1块)",
                                 "Expander-硬盘粒度为512B-SATA-SSD(1块)+Expander-硬盘粒度为512B-SAS-SSD(1块)+"
                                 "Expander-硬盘粒度为512B-NVME-SSD(1块)",
                                 "Expander-硬盘粒度为512B-SATA-SSD(1块)+Expander-硬盘粒度为512B-SAS-SSD(1块)+"
                                 "PCIE·Switch-硬盘粒度为512B-NVME-SSD(1块)"]
        pd_info_list_mix_ssd = ["直连背板-硬盘粒度为512E-SATA-SSD(1块)+Expander-硬盘粒度为512E-SAS-SSD(1块)+"
                                "PCIE·Switch-硬盘粒度为512E-NVME-SSD(1块)",
                                "直连背板-硬盘粒度为512E-SATA-SSD(1块)+直连背板-硬盘粒度为512E-SAS-SSD(1块)+"
                                "直连背板-硬盘粒度为4KN-NVME-SSD(1块)",
                                "Expander-硬盘粒度为512E-SATA-SSD(1块)+Expander-硬盘粒度为512B-SAS-SSD(1块)+"
                                "PCIE·Switch-硬盘粒度为4KN-NVME-SSD(1块)"]

        pd_info_list_4kn_sata = ["直连背板-硬盘粒度为4KN-SATA-SSD(2块)+Expander-硬盘粒度为4KN-SATA-HDD(2块)",
                                 "直连背板-硬盘粒度为4KN-SATA-SSD(2块)+直连背板-硬盘粒度为4KN-SATA-HDD(2块)",
                                 "Expander-硬盘粒度为4KN-SATA-SSD(2块)+Expander-硬盘粒度为4KN-SATA-HDD(2块)"]

        pd_info_list_512B_sata = ["直连背板-硬盘粒度为512B-SATA-SSD(2块)+Expander-硬盘粒度为512B-SATA-HDD(2块)",
                                  "直连背板-硬盘粒度为512B-SATA-SSD(2块)+直连背板-硬盘粒度为512B-SATA-HDD(2块)",
                                  "Expander-硬盘粒度为512B-SATA-SSD(2块)+Expander-硬盘粒度为512B-SATA-HDD(2块)"]

        pd_info_list_mix_sata = ["直连背板-硬盘粒度为512E-SATA-SSD(2块)+Expander-硬盘粒度为512E-SATA-HDD(2块)",
                                 "直连背板-硬盘粒度为512E-SATA-SSD(2块)+直连背板-硬盘粒度为512B-SATA-HDD(2块)",
                                 "Expander-硬盘粒度为512E-SATA-SSD(2块)+Expander-硬盘粒度为512B-SATA-HDD(1块)+"
                                 "Expander-硬盘粒度为4KN-SATA-HDD(1块)"]

        pd_info_list_4kn_sas = ["直连背板-硬盘粒度为4KN-SAS-SSD(2块)+Expander-硬盘粒度为4KN-SAS-HDD(2块)",
                                "直连背板-硬盘粒度为4KN-SAS-SSD(2块)+直连背板-硬盘粒度为4KN-SAS-HDD(2块)",
                                "Expander-硬盘粒度为4KN-SAS-SSD(2块)+Expander-硬盘粒度为4KN-SAS-HDD(2块)"]

        pd_info_list_512B_sas = ["直连背板-硬盘粒度为512B-SAS-SSD(2块)+Expander-硬盘粒度为512B-SAS-HDD(2块)",
                                 "直连背板-硬盘粒度为512B-SAS-SSD(2块)+直连背板-硬盘粒度为512B-SAS-HDD(2块)",
                                 "Expander-硬盘粒度为512B-SAS-SSD(2块)+Expander-硬盘粒度为512B-SAS-HDD(2块)"]

        pd_info_list_mix_sas = ["直连背板-硬盘粒度为512B-SAS-SSD(2块)+Expander-硬盘粒度为512E-SAS-HDD(2块)",
                                "直连背板-硬盘粒度为512E-SAS-SSD(2块)+直连背板-硬盘粒度为512E-SAS-HDD(2块)",
                                "Expander-硬盘粒度为512E-SAS-SSD(2块)+Expander-硬盘粒度为512B-SAS-HDD(1块)+"
                                "Expander-硬盘粒度为4KN-SATA-HDD(1块)"]
