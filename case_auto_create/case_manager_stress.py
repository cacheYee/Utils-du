...
class CaseManager(object):
    ...
    def create_case_list(cls) -> None:
        ...
        pd_info_list_hdd = ["直连背板-硬盘粒度为512B-SATA-HDD(4块)",
                            "直连背板-硬盘粒度为512E-SAS-HDD(4块)",
                            "Expander-硬盘粒度512E-SAS-HDD(4块)",
                            "直连背板-硬盘粒度为4KN-SAS-HDD(2块)+Expander-硬盘粒度为4KN-SATA-HDD(2块)",
                            "直连背板-硬盘粒度为512E-SATA-HDD(2块)+直连背板-硬盘粒度为4KN-SAS-HDD(2块)",
                            "直连背板-硬盘粒度为512B-SATA-HDD(1块)+直连背板-硬盘粒度为4KN-SAS-HDD(1块)+"
                            "Expander-硬盘粒度为512E-SATA-HDD(1块)+Expander-硬盘粒度为512B-SAS-HDD(1块)"
                            ]

        pd_info_list_ssd = ["直连背板-硬盘粒度为512B-SATA-SSD(4块)",
                            "直连背板-硬盘粒度为512E-SAS-SSD(4块)",
                            "直连背板-硬盘粒度为4KN-NVME-SSD(4块)",
                            "Expander-硬盘粒度512E-SAS-SSD(4块)",
                            "PCIE·Switch-硬盘粒度为4KN-NVME (4块)",
                            "直连背板-硬盘粒度为512B-SAS-SSD(2块)+PCIE·Switch-硬盘粒度为512E-NVME(2块)",
                            "Expander-硬盘粒度为4KN-SATA-SSD(2块)+PCIE·Switch-硬盘粒度为512B-NVME(2块)",
                            "直连背板-硬盘粒度为4KN-SATA-SSD(2块)+Expander-硬盘粒度为4KN-SAS-SSD(2块)",
                            "直连背板-硬盘粒度为512E-SATA-SSD(1块)+直连背板-硬盘粒度为4KN-SAS-SSD(1块)+"
                            "Expander-硬盘粒度为4KN-SATA-SSD(1块)+PCIE·Switch-硬盘粒度为512B-NVME(1块)"]
